...
public class FabricaDeInstancia{
  ...
  public static RealizaEmprestimo emprestar() {
	  
	  return new RealizaEmprestimo();
  }
  public static RealizaReserva reservar() {
	  
	  return new RealizaReserva();
  }
  public static DevolveLivro devolver() {
	  
	  return new DevolveLivro();
}
  public static ConsultaLivro consultar() {
	  
	  return new ConsultaLivro();
}
  public static ConsultaHistorico historicoUser() {
	  
	  return new ConsultaHistorico();
}
  public static AtivaObservador observer() {
	  
	  return new AtivaObservador();
}
}